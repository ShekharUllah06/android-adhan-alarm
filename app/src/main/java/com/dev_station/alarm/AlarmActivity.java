 ...
 */
package com.dev_station.alarm;

import java.util.List;

import com.dev_station.alarm.database.Database;
import com.dev_station.alarm.preferences.AlarmPreferencesActivity;
...
public class AlarmActivity extends BaseActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		//menu.findItem(R.id.menu_item_rate).setVisible(false);
		//menu.findItem(R.id.menu_item_website).setVisible(false);
